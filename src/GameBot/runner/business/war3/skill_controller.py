...
class SkillControllerMixin:
    ...
    def cast_skill(
        self, skill_cfg: dict, coords=None, target_coords=None, stop_event: Optional[threading.Event] = None
    ):
        """
        施放技能
    ...
    def execute_combo(
        self, combo_cfg: List[Dict], coords=None, target_coords=None, stop_event: Optional[threading.Event] = None
    ):
        """
        连招
        :combo_cfg: combo配置
